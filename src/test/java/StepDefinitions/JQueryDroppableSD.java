...
public class JQueryDroppableSD extends SeleniumDriver {
	...
	public void tries_to_move_the_drag_me_object_to_drop_me_object() {
		...
		act.dragAndDrop(SeleniumHelper.GetWebElement(jQueryDroppableLocators.draggable, Locator.Id),
				SeleniumHelper.GetWebElement(jQueryDroppableLocators.droppable, Locator.Id)).build().perform();
	}
